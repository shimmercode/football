...
v3.12.18:
- بازگرداندن جدول، آمار و نقل‌وانتقالات نسخه پایدار؛ برنامه بازی‌ها همه هفته‌های صفحه matches را می‌خواند
...
v3.12.14:
- بازگرداندن کامل دریافت داده از نسخه پایدار ۳.۱۲.۱۱

v3.12.13:
- بازگرداندن جدول، آمار و برنامه بازی‌ها؛ صفحه سنگین جدول دیگر بقیه بخش‌ها را خالی نمی‌کند

v3.12.12:
- جدول هر لیگ فقط از صفحه جدول همان شناسه خوانده می‌شود و ردیف تکراری حذف می‌گردد
- نمایش آخرین به‌روزرسانی شمسی بالای جدول
- تب بهترین‌های ماه از صفحه monthly-best فوتبال۳۶۰

v3.12.11:
- صفحه‌بندی نقل‌وانتقالات بعد از لود هر لیگ کار می‌کند
- لیست نقل‌وانتقالات از صفحه اختصاصی لیگ و منبع پشتیبان کامل‌تر می‌شود

v3.12.9:
- جدول هر تیم از همان ردیف رسمی فوتبال۳۶۰ خوانده می‌شود تا آمار تکراری نشود
- نام تیم در آمار گلزنان از ردیف همان بازیکن گرفته می‌شود
- برنامه بازی‌ها با تاریخ شمسی، یک ساعت، و صفحه‌بندی هفته‌ای

v3.12.8:
- ظاهر مینیمال‌تر جدول و حذف بخش درباره لیگ
