        ...
        <div class="f360ls-card">
            ...
            <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" enctype="multipart/form-data">
                ...
                <table class="form-table">
                    ...
                    <tr><th><label for="table_url">لینک اختصاصی جدول</label></th><td><input name="table_url" id="table_url" type="url" class="large-text" placeholder="https://football360.ir/league/table?id=...&query=full"><p class="description">اختیاری؛ لینک جدول کامل فوتبال۳۶۰ با شناسه لیگ.</p></td></tr>
